            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                    <div class="item-block-content">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                                <div class="item-block-image">
                                    <img class="img-fluid mt-4" src="<?= base_url('assets/images/blog/lithophane-two.jpg'); ?>">
                                </div>    
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                                <div class="item-block-image">
                                    <img class="img-fluid mt-4" src="<?= base_url('assets/images/blog/lithophane-one.png'); ?>">
                                </div>    
                            </div>
                        </div>                         
                        <p>By the mid-19th century, lithophane was being produced throughout Europe. Common themes for lithophane were religion, portraits, genre themes, stories from the bible and some even commemorated events like the opening of the Eiffel Tower.</p>
                        ...
                        <p>3D printing has evolved this style of art, if not saved it among all the noise in the modern world.</p>
                    </div>    
                </div>
            </div>
            <hr>
