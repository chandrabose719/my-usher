            ...
            <div class="row">
            	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">	
                    <div class="item-head-content">
                    	<h1>Automotive Car Parts and 3D Printing</h1>
                    </div>    
            	</div>
            </div>
        </div>
    ...
    <section id="blog-item-block">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                    <div class="item-block-content">
                        <p>Assembly line of Volkswagen Autoeuropa implemented 3D printing and here is what they’ve achieved:</p>
                        <ul>
                            <li>
                                <p>They saved €150,000 by implementing 3D printing for auto-parts manufacturing in just one year.</p>
                            </li>
                            <li>
                                <p>Within just two months of implementing 3D printing in their assembly line, they accomplished 100 percent return on investment.</p>
                            </li>
                            <li>
                                <p>Volkswagen expects to save €250,000 through 3D printing in subsequent years.</p>
                            </li>
                        </ul>
                    </div>    
                </div>
