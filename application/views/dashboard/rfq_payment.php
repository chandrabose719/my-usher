    <div class="manufacturing-part">
        <div class="manufacturing-content">    
            <h3><?= $this->lang->line('rfq_header');?></h3>
            <?php
                            ...
                            <div class="float-right float-xs-none">
                                <div class="btn-group">
                                    <?php
                                        ...
                                        $stripe_amount = $payment_amount;
                                        $stripe_amount = number_format($stripe_amount, 2);
                                        $stripe_amount = $stripe_amount * 100;
                                    ?>    
                                    <form method="POST" action="<?= base_url('rfq-payment-submit'); ?>">
                                        <input type="hidden" id="stripe_amount" name="stripe_amount" value="<?= $stripe_amount; ?>">
                                        <input type="hidden" id="order_id" name="order_id" value="<?= $order_data->order_id; ?>">
                                        <script
                                            src="https://checkout.stripe.com/checkout.js" 
                                            class="stripe-button"
                                            data-key="<?= $this->config->item('publishableKey'); ?>"
                                            data-amount="<?= $stripe_amount; ?>"
                                            data-name="<?= 'Welcome '.$usher_name; ?>"
                                            data-description=""
                ...
                <div class="order-body">  
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            ...
                            <?php
                                // Technology Name
                                $tech_array['technology_id'] = $order_data->technology_id;
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <h4 class="manu-design"> <?= $this->lang->line('price_details');?> </h4>
                            <p><?= $this->lang->line('unit_price');?>: &dollar;<?= $file_data->file_amount;?></p>
                            <p>
                                <?php
                                    $total_price = $file_data->file_amount * $file_data->file_qty;
                                    echo $this->lang->line('total_price').': &dollar;'.$total_price; 
                                ?>
                            </p>
                        </div>
                    </div>        
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 offset-xl-4 col-lg-4 offset-lg-4 col-md-4 offset-md-4 col-sm-6 col-xs-12">
                            <div class="btn-group float-right float-xs-none pr-3">    
                                <div class="btn-group float-right float-xs-none pr-3">    
                                    <h4><span><?= $this->lang->line('payable_amount');?></span> &dollar;<?= number_format($order_data->payment_amount, 2); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
