<div id="industry-part" class="px-5">    
    <section id="industry-head" class="education">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                    <div class="industry-block-content">
                    	<h4>Application in Research and Education</h4>
                        <ul class="industry-block-list">
                            <li>
                                <p>The school students use it to print organ, molecules, history projects, and artworks.</p>
                            </li>
                            <li>
                                <p>Architecture students can design and print their 3D models.</p>
                            </li>
                            <li>
                                <p>Future engineers can print the prototypes of their projects.</p>
                            </li>
                        </ul>
                    </div>    
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                    <div class="industry-block-image">
                        <img class="img-fluid mt-4" src="<?= base_url('assets/images/static-industry/static-education.png'); ?>">
                    </div>    
                </div>
            </div>
            <hr>
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                    <div class="industry-block-content">
                        <p>Our efficient On-Demand Manufacturing service at 3D Usher can share and ease your burden. So, if you are keen to preserve and nurture the curiosity of your students, contact us!</p>
                    </div>    
                </div>
            </div>
            <hr>
