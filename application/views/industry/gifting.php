<div id="industry-part" class="px-5 wrapper-body-padding">    
    <section id="industry-head" class="gifting">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12"> 
                    <div class="industry-block-content">
                    	<h4>Here's How:</h4>
                        <p>You can select from a wide category of gifts with which you can relate the most. With our on-demand manufacturing, you can give a traditional gift a fantastic make-over. Using this, you can create:</p>
                        <ul class="industry-block-list">
                            <li>
                                <p>Figurines and toys</p>
                            </li>
                            <li>
                                <p>Phone Cases</p>
                            </li>
                            ...
                            <li>
                                <p>Other designs and decorations</p>
                            </li>
                        </ul>
                    </div>    
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12"> 
                    <div class="industry-block-image">
                        <img class="img-fluid mt-4" src="<?= base_url('assets/images/static-industry/static-gifting.png'); ?>">
                    </div>    
                </div>
            </div>
            <hr>
