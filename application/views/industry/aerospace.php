<div id="industry-part" class="px-5 wrapper-body-padding">
    <section id="industry-head" class="aerospace">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12"> 
                    <div class="industry-block-content">
                    	<h4>Benefits of on-demand manufacturing in Aerospace</h4>
                        <ul class="industry-block-list">
                            <li>
                                <p>Requires less time to produce parts</p>
                            </li>
                            <li>
                                <p>Reduces the entire cost</p>
                            </li>
                            <li>
                                <p>Saves materials</p>
                            </li>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12"> 
                    <div class="industry-block-image">
                        <img class="img-fluid mt-4" src="<?= base_url('assets/images/static-industry/static-aerospace.png'); ?>">
                    </div>    
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <a href="<?= base_url('architecture'); ?>">    
                        <div class="mt-4 industry-block-icon">
