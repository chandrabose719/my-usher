            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-8 offset-xl-2 col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-sm-12 col-xs-12">
                        <h3>How It Works</h3>
                        <p>Choose “Design Services” if you need 3D Usher designers to create a CAD file for your project. If you already have a CAD file, choose “Manufacturing Services"</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-4 offset-xl-2 col-lg-4 offset-lg-2 col-md-4 offset-md-2 col-sm-12 col-xs-12">
                        <div class="how-it-work-content">
                            ...
                            <p></p>
                            <div class="page-scroll">
                                <a class="btn btn-light" href="#home-design-flow">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="how-it-work-content">
                            ...
                            <p></p>
                            <div class="page-scroll">
                                <a class="btn btn-light" href="#home-manufacture-flow">
                                    <i class="fas fa-angle-double-down"></i>
                                </a>
                            </div>    
                        </div>    
