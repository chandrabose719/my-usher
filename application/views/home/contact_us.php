<div id="contact-part" class="px-5">    
    <section id="contact">
        <div class="container">
            <div class="row">
            	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">	
                    <div class="contact-content">
                    	<h1>Contact @ 3D Usher</h1>
                    </div>    
            	</div>
            </div>
        </div>
    ...
    <section id="contact-address">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                    <div class="contact-address-content">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.5356036135167!2d78.42318221444042!3d17.481927688022054!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb91cf5a732663%3A0xf7fea22bc38ff608!2s3D+Usher!5e0!3m2!1sen!2sin!4v1536919816610" width="100%" height="350px" frameborder="0"></iframe>
                    </div>    
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                            <div class="form-group">
                                <input type="text" class="form-control custom-input" name="contact_name" id="contact_name" placeholder="Name *">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                            <div class="form-group">
                                <input type="email" class="form-control custom-input" name="contact_email" id="contact_email" placeholder="Email ID *">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                            <div class="form-group">
                                <input type="number" class="form-control custom-input" name="contact_mobile" id="contact_mobile" placeholder="Phone Number *">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                            <div class="form-group">
                        ...
                        <div class="col-xl-4 offset-xl-6 col-lg-4 offset-lg-6 col-md-4 offset-md-6 col-sm-4 offset-sm-6 col-xs-12"> 
                            <div class="form-group">
                                <input type="submit" class="form-control btn btn-primary Pbtn" name="contact-submit" value="SUBMIT">
                            </div>
                        </div>    
                    </div>
                </form>
