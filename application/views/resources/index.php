<div id="resource-part" class="px-5">    
    <section id="resource" class="resource-home">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="resource-group-content">
                        ...
                        <div class="row">
                            <div class="col-6 col-xs-12">        
                                <a href="<?= base_url('resources/fused-deposition-modeling'); ?>">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="resource-group-content">
                        <div class="content-body">
                            <h4>Selective Laser Sintering</h4>
                            <p>Selective Laser Sintering (SLS) is a 3D manufacturing technique used to turn digital designs into 3D products.</p>
                        </div>
                        <div class="hr-divider"></div>
                        <div class="row">
                            <div class="col-6 col-xs-12">        
                                <a href="<?= base_url('resources/selective-laser-sintering'); ?>">
                                    <p class="ml-1">learn more</p>
                                </a>
                            </div>
                        </div>    
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <h4>3D Usher has stringent quality control measures and takes great care <br/> to keep our clients' IP safe.</h4>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a class="btn btn-primary Pbtn Pbtn-two" href="<?= base_url('contact-us'); ?>">CONTACT US</a>
                </div>
            </div>    
        </div>
    </section>
